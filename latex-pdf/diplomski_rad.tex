...
\begin{figure}[H]
    \centering
    \includegraphics[height=5cm]{img/python-sintaksa}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=15cm]{img/pytorch-architecture}
    \caption{Arhitektura renderera PyTorch3D biblioteke}
    \label{fig:pytorch-architecture}
\end{figure}
\footnotetext{Preuzeto sa \url{https://pytorch3d.org/docs/renderer_getting_started}}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=15cm]{img/c-code}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=15cm]{img/panda-images}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=15cm]{img/500-iteracij}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=12cm]{img/final-slike}
...
Rezultate generiramo u datoteci \textttt{nerf-testing.py} te ih možemo vidjeti na slici \ref{fig:final-slike-3d}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=15cm]{img/15-slika}
...
% Abstract in English
\begin{abstract}
    Understanding the kinematics of a manipulator and its configuration in space is very important for successfully performing tasks.
    To successfully define the kinematics of a manipulator, it is necessary to know its model.
    The aim of this paper was to present a method for obtaining a 3D model of a robot in a specific configuration using the NeRF model.
    Throughout the paper, we will explain the robot's forward and inverse kinematics and the methods for obtaining visual representations.
    Finally, we will present the obtained results along with possible improvements to our existing approach.

\end{abstract}

\begin{keywords}
    kinematics; manipulator; configuration; rendering; NeRF; 3D model
\end{keywords}
